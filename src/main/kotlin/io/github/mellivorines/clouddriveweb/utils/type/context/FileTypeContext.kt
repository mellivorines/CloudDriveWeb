package io.github.mellivorines.clouddriveweb.utils.type.context

import io.github.mellivorines.clouddriveweb.utils.ReflectUtil
import io.github.mellivorines.clouddriveweb.utils.type.FileTypeDefiner
...
object FileTypeContext {
    ...
    init {
        val allSubTypeOfFileTypeDefiner: Set<Class<*>> = ReflectUtil.getAllSubTypeOf(
            FileTypeDefiner::class.java, "com.rubin.rpan.util.file.type"
        )
